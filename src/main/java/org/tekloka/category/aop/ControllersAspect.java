package org.tekloka.category.aop;
...
import org.tekloka.category.constants.RoleConstants;
import org.tekloka.category.exception.UnauthorizedException;
import org.tekloka.category.security.AccessPermissions;
import org.tekloka.category.security.SecurityCache;
import org.tekloka.category.util.DataUtil;
...
public class ControllersAspect {
	...
	@Before("@annotation(org.tekloka.category.security.AccessPermissions)")
	...
	@Before("@annotation(org.tekloka.category.security.AllowFeignClient)")
